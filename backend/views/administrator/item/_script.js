...
function listUsers() {
  ...
  if (_opts.users.prev) {
    users.push(
      `<span class="label label-primary"><a href="#" data-target="${_opts.users.prev}">&laquo;</a></span>`
    );
  }
  if (_opts.users.next) {
    users.push(
      `<span class="label label-primary"><a href="#" data-target="${_opts.users.next}">&raquo;</a></span>`
    );
  }
