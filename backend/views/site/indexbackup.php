...
$this->registerJsVar('selectedValuesToIndices', [1, 2, 3, 4]);
            ...
            if (Array(response)) {
                for (var i = 0; i < response.length; i++) {
                    ...
                    if (Array(questionTextArray) && questionTextArray.length > 0) {
                        ...
                        stringWithoutCommas = questionText.replace(regex, ''); 
                        var questionText = stringWithoutCommas.replace(/,/g, '');
                           


                        $('.description-block').append('<span>' + questionText + '</span>');
                    } else {
