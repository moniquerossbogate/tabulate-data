...
$this->title = '';
$this->params['breadcrumbs'][] = "Questionnaire";
?>
<div class="component-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
                ...
                [
                    'content' =>
                        Html::a(
                            ...
                            ['create'],
                            ['role' => 'modal-remote', 'title' => 'Create new Title', 'class' => 'btn btn-default btn-sm']
                        ) .
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Add Questionnaire Title',
