...
$menuItems = [
    ['label' => 'Questionnaire', 'url' => ['/questionnaire/index'], 'icon' => 'question'],
    ['label' => 'Choices', 'url' => ['/choices/index'], 'icon' => 'list'],
    ['label' => 'Response', 'url' => ['/response/index'], 'icon' => 'list'],

];

$userItems = [
    ['label' => 'Users Profile', 'url' => ['/personnel/index'], 'icon' => 'users'],
];
