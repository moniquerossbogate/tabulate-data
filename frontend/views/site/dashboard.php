...
<style>
    body {
        ...
        color: white; /* Optional: sets text color to white for better readability */
    }
</style>
...
// Assuming $typeData is an array containing your chart data
    ...
    // Function to show selected question below the chart
    function showQuestions(selectedQuestionId) {
        const selectedQuestionText = typeData[selectedQuestionId];
        const questionContainer = document.getElementById('question-container');
        if (questionContainer) {
            questionContainer.textContent = selectedQuestionText;
        }
    }
